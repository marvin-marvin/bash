...
alias _exec3='echo "vps-ger-nue-kube-3" ; _execute "${vpsgernuekube3}" root "${vpsgernuekube3p}" ${COMMAND}'
alias _exec4='echo "vps-us-chi-kube-4" ; _execute "${vpsuschikube4}" root "${vpsuschikube4p}" ${COMMAND}'
