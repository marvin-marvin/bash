...
alias _exec1='echo ; echo -e "\e[1mvps-us-ny-kube-1\e[0m" ; _execute "${vpsusnykube1}" root "${vpsusnykube1p}" ${COMMAND}'
alias _exec2='echo ; echo -e "\e[1mvps-us-lax-kube-2\e[0m" ; _execute "${vpsuslaxkube2}" root "${vpsuslaxkube2p}" ${COMMAND}'
alias _exec3='echo ; echo -e "\e[1mvps-ger-nue-kube-3\e[0m" ; _execute "${vpsgernuekube3}" root "${vpsgernuekube3p}" ${COMMAND}'
alias _exec4='echo ; echo -e "\e[1mvps-us-chi-kube-4\e[0m" ; _execute "${vpsuschikube4}" root "${vpsuschikube4p}" ${COMMAND}'
